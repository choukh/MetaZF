...
Inductive 有穷集 : 𝓜 → Prop :=
  | 有穷集_空 : 有穷集 ∅
  | 有穷集_并 x y : 有穷集 y → 有穷集 (x ⨮ y).

Lemma 有穷集对子集封闭 a b : b ⊆ a → 有穷集 a → 有穷集 b.
Proof.
...
Lemma 有穷集对二元并封闭 a b : 有穷集 a → 有穷集 b → 有穷集 (a ∪ b).
Proof.
...
Lemma 有穷集对替代封闭 R a : 函数性 R → 有穷集 a → 有穷集 (R @ a).
Proof.
...
Corollary 有穷集对函数式替代封闭 F a : 有穷集 a → 有穷集 F[a].
Proof. intros H. apply 有穷集对替代封闭; congruence. Qed.

Lemma 有穷集对幂集封闭 a : 有穷集 a → 有穷集 (𝒫 a).
Proof.
...
Inductive 遗传有穷集 : 𝓜 → Prop :=
  | 遗传有穷集引入 x : 有穷集 x → (∀ y ∈ x, 遗传有穷集 y) → 遗传有穷集 x.

(* 遗传有穷集之类 *)
Notation HF := 遗传有穷集.

Lemma HF集是有穷集 x : HF x → 有穷集 x.
